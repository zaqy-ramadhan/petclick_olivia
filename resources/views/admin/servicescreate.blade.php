                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <strong >Services ID:</strong>
                                                <input type="text" name="id" class="form-control mt-2" placeholder="Services ID">
                                            @error('id')
                                        ...
                                        <div class="form-group mt-2">
                                            <strong >Services Name:</strong>
                                                <input type="text" name="name" class="form-control mt-2" placeholder="Services Name">
                                            @error('name')
                                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="form-group mt-2">
                                            ...
                                            <div class="form-group mt-2">
                                                <strong >Routes:</strong>
                                                    <input type="text" name="routes" class="form-control mt-2" placeholder="Insert Routes">
                                                @error('name')
                                                    <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                                @enderror
                                            </div>
