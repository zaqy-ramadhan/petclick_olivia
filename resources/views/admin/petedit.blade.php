                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12">
                                        <div class="form-group">
                                            <strong >Pet ID:</strong>
                                                <input type="text" name="id" value="{{ $pet->id }}" class="form-control mt-2" placeholder="Pet ID">
                                            @error('id')
                                        ...
                                        <div class="form-group mt-2">
                                            <strong >Pet Name:</strong>
                                                <input type="text" name="name" value="{{ $pet->pet_name }}" class="form-control mt-2" placeholder="Pet Name">
                                            @error('name')
                                                <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                                            @enderror
                                        </div>
